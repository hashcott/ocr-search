...
import { Membership, MemberRole, ROLE_HIERARCHY } from "../db/models/Membership";
...
const SetCustomPermissionsSchema = z.object({
  ...
  customPermissions: z.array(z.object({
    ...
    actions: z.array(z.enum(["manage", "create", "read", "update", "delete", "share", "export", "invite"])),
  })),
});
...
export const organizationRouter = router({
  ...
  getById: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      ...
      const canManage = ability.can("manage", "Organization", { organizationId: input.id });
      const canUpdate = ability.can("update", "Organization", { organizationId: input.id });
  ...
  update: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      await authorize(ctx.userId!, "update", "Organization", { organizationId: input.id });
  ...
  listMembers: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      await authorize(ctx.userId!, "read", "Member", { organizationId: input.organizationId });
  ...
  inviteMember: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      await authorize(ctx.userId!, "invite", "Member", { organizationId: input.organizationId });
  ...
  updateMemberRole: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      await authorize(ctx.userId!, "update", "Member", { organizationId: input.organizationId });
  ...
  setCustomPermissions: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      await authorize(ctx.userId!, "manage", "Member", { organizationId: input.organizationId });
  ...
  removeMember: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      await authorize(ctx.userId!, "delete", "Member", { organizationId: input.organizationId });
  ...
  getMyPermissions: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      ...
      const actions = ["manage", "create", "read", "update", "delete", "share", "export", "invite"] as const;
      ...
      for (const resource of resources) {
        ...
        for (const action of actions) {
          if (ability.can(action, resource, { organizationId: input.organizationId })) {
            allowed.push(action);
          }
        }
